...
class SERefineRes34Unet(nn.Module):
    ...
    def __init__(self):
        ...
        self.refine_net.mrf.resolve0 =  Conv2d(32, 32, kernel_size=(3, 3), stride=(1, 1), padding=(1, 1), bias=False)
    ...
    def forward(self, x):
        ...
        d  = self.decoder1(d)
        h1 = self.hyper1(d)
        print(hbot.shape,h5.shape,h4.shape,h3.shape,h2.shape,h1.shape)
